...
All live under `${CLAUDE_PLUGIN_ROOT}/skills/mobile-design/`.
...
Apply decision frameworks from `decision-trees.md`:
...
|----------|------------------|
| `/security-review` | After auth/token handling or native-module additions |
| `/simplify` | After implementation, before declaring done |
