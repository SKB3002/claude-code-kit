...
> **Note:** The `game-development` skill bundles sub-topics (pc-games, web-games, mobile-games, game-design, multiplayer, vr-ar, 2d-games, 3d-games, game-art, game-audio) — consult the skill's `SKILL.md` index and follow pointers to the relevant sub-file for your target.
