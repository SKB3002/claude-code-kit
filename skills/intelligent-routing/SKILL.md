...
### With KIT_PROTOCOL.md Rules

- **Priority**: KIT_PROTOCOL.md rules > intelligent-routing
- If KIT_PROTOCOL.md (or the host project's `CLAUDE.md`) specifies explicit routing, follow it
...
Add to `KIT_PROTOCOL.md` (or your project's `CLAUDE.md`) temporarily:
...
**Next Steps**: This skill is wired into `KIT_PROTOCOL.md` TIER 0 rules by default.
